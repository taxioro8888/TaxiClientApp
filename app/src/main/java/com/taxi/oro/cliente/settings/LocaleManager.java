package com.taxi.oro.cliente.settings;
...
public class LocaleManager {
    ...
    @StringDef({ ENGLISH, HINDI, SPANISH, FRANCAIS, CHINA, JAPAN, ARABIC, BANGLADESH,GERMANY, KOREA, PORTUGAL, RUSSIA,Perú })
    public @interface LocaleDef {
        String[] SUPPORTED_LOCALES = { ENGLISH, HINDI, SPANISH, FRANCAIS, CHINA, JAPAN, ARABIC, BANGLADESH,GERMANY, KOREA, PORTUGAL, RUSSIA,Perú };
    }
    ...
    public static final String Perú = "pe";
    /**
