...
import com.taxi.oro.cliente.model.User;
...
public class LoginActivity extends BaseActivity {
    ...
    private boolean validatePhoneLogin() {
        if (input_phone.getText().toString().trim().isEmpty()) {
            Toast.makeText(LoginActivity.this,"ingrese telefono",Toast.LENGTH_SHORT).show();
    ...
    private boolean validatePhoneValidLogin() {
        if (input_phone.getText().toString().trim().length() < 7) {
            Toast.makeText(LoginActivity.this,"NUmero no valido",Toast.LENGTH_SHORT).show();
            requestFocus(input_phone);
            return false;
        } else {
    ...
    private boolean validatePasswordValidLogin() {
        if (password.getText().toString().trim().length() < 4) {
            Toast.makeText(LoginActivity.this,"requere mas de 4 caracteres",Toast.LENGTH_SHORT).show();
            requestFocus(password);
            return false;
        } else {
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                if(etat.equals("1")){
                                    ...
                                    Toast.makeText(context, context.getResources().getString(R.string.this_account_does_not_exist), Toast.LENGTH_SHORT).show();
                                    requestFocus(input_phone);
                                    Toast.makeText(LoginActivity.this,"ingrese otro telefono",Toast.LENGTH_SHORT).show();
                                    ...
                                    requestFocus(password);
                                    Toast.makeText(LoginActivity.this,"ingrese otro contraseña",Toast.LENGTH_SHORT).show();
                                }else {
                                    requestFocus(input_phone);
