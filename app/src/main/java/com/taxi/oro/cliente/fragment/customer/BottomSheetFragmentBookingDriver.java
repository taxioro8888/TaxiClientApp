...
import com.taxi.oro.cliente.adapter.CommentAdapter;
import com.taxi.oro.cliente.adapter.DriverAdapter;
import com.taxi.oro.cliente.adapter.PaymentMethodAdapter;
import com.taxi.oro.cliente.circleimage.CircleImageView;
import com.taxi.oro.cliente.controller.AppController;
import com.taxi.oro.cliente.model.CommentPojo;
import com.taxi.oro.cliente.model.DriverPojo;
import com.taxi.oro.cliente.model.M;
import com.taxi.oro.cliente.model.PaymentMethodPojo;
...
public class BottomSheetFragmentBookingDriver extends BottomSheetDialogFragment {
    ...
    public static final String[] MONTHS = {"Ene", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Ago", "Sep", "Oct", "Nov", "Dec"};
